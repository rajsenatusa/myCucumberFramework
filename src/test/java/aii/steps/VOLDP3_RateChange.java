...
//		PdfComparator.verifyFormData(driver, RwlCheckList_Version, Cov_A_InfaltionValue);
		PdfComparator.verifyFormData(driver, RwlCheckList_Version, "$600,000");
		PdfComparator.verifyFormData(driver, RwlCheckList_Version, "$12,000");
		PdfComparator.verifyFormData(driver, RwlCheckList_Version, "$150,000");
		PdfComparator.verifyFormData(driver, RwlCheckList_Version, "$60,000");
		PdfComparator.verifyFormData(driver, RwlCheckList_Version, "OIR-B1-1670");
		Hooks.scenario.log("Test Case Completed!");
	}
