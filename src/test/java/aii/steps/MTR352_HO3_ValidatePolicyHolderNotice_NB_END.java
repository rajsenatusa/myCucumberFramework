...
public class MTR352_HO3_ValidatePolicyHolderNotice_NB_END extends CommonMethods{
	...
	public void user_clicks_application_link_and_do_validation_of_application_form_version() throws Exception {
		...
		application_Form_FnE1 = SmartPDFComparator2.getPDFtextByArea(FileLocation+application_Form, 2, 40, 280, 560, 270);
	...
	public void user_clicks_new_business_package_link_and_do_validation_of_nb_form_version() throws Exception {
		...
		PolicyHolderNotice_NBpack_Version1 = SmartPDFComparator2.getPDFtextByArea(FileLocation+package_Form, 3, 400, 0, 200, 50);
		PdfComparator.verifyFormData(driver, PolicyHolderNotice_NBpack_Version1, "AIIC HO3 PHN CSAU 11 21");
		PolicyHolderNotice_NBpack_Version = SmartPDFComparator2.getPDFtextByArea(FileLocation+package_Form, 2, 70, 740, 200, 50);
	...
	public void User_clicks_policy_holder_notice_endorsement_form_and_Do_validations() throws Exception {	    	   						
		...
		wait(8);
		PolicyHolderNotice_END_Version1 = SmartPDFComparator2.getPDFtextByArea(FileLocation + PolicyHolderNotice_ENDForm, 2, 400, 0, 200, 50);
		PdfComparator.verifyFormData(driver, PolicyHolderNotice_END_Version1, "AIIC HO3 PHN CSAU 11 21");
		PolicyHolderNotice_END_Version = SmartPDFComparator2.getPDFtextByArea(FileLocation + PolicyHolderNotice_ENDForm, 1, 70, 740, 200, 50);
