...
public class TC35177_MHO_NB_ValidateAgentCannotIssueNBforCompositionShingleAndRoofGreater16_UWCanIssue extends CommonMethods{
	...
	public void user_enters_all_required_information_on_mho3_quote_screen_and_selects_park_tc35177()
			throws Exception {
	...
	public void user_checks_application_dwelling_screen_validates_risk_ineligible_message_displayed_and_finalizes_transaction() throws Exception {
	...
	public void user_validates_issue_new_business_and_submit_for_approval_buttons_are_not_visible_on_closeout_screen() throws Exception {
	...
	public void user_validates_Risk_is_ineligible_based_upon_roof_material_and_roof_age_message_has_been_displayed() throws Exception {
		verify_AnyText_IsVisible(driver, "Risk is ineligible based upon roof material and roof age");
	}
