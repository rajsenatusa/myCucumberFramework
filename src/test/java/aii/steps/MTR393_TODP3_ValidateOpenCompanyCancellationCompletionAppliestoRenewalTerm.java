...
public class MTR393_TODP3_ValidateOpenCompanyCancellationCompletionAppliestoRenewalTerm extends CommonMethods {
	...
	@When("User enters all required information on policy information screen <mtr393>")
	public void user_enters_all_required_information_on_policy_information_screen_mtr393() {
	...
	@When("User enters all required information on TODP3 quote screen <mtr393>")
	public void user_enters_all_required_information_on_todp3_quote_screen_mtr393() {
	...
	@When("User enters all required information on TODP3 dwelling screen <mtr393>")
	public void user_enters_all_required_information_on_todp3_dwelling_screen_mtr393() {
	...
	public void user_validates_that_todp3_policy_has_been_created_successfully_and_takes_note_of_policy_number()
			throws Exception {
