...
public class MTR5332_IM_614_AIB_END_Validate_mailing_address_can_be_updated_through_copy_to_mailing_address_link
...
//		selectDropdownText(policyChevron.txtProducerCodeSel, "AG1730A1");
	...
	@Given("User modifies Location address as '12 Needle Cast Ln, 32461'")
	public void User_modifies_Location_address_as_12_Needle_Cast_Ln_32461() throws Exception {

		policyChevron.txtResidentPrimaryNumber.clear();
		policyChevron.insuredResidentAddrPreDirectional.clear();
		policyChevron.txtStreet.clear();
		policyChevron.txtPostalCode.clear();
		sendText(policyChevron.txtResidentPrimaryNumber, "12");
		sendText(policyChevron.txtStreet, "Needle Cast Ln");
		sendText(policyChevron.txtPostalCode, "32461");
		wait(2);
		driver.findElement(By.id("InsuredResidentAddr.addrVerifyImg")).click();
		wait(1);
		click(policyChevron.copyAddress);
		click(policyChevron.copyToBillAddress);
		wait(1);

	}

	@Then("User verifies modified Mailing Address and Billing Address")
	public void User_verifies_modified_Mailing_Address_and_Billing_Address() throws Exception {
		verify_AnyfirstText_IsDisplayed(driver, "12 Needle Cast Ln");
		Hooks.scenario.log("Revised mailing address displays successfully!");
		wait(1);
		verify_AnyfirstText_IsDisplayed(driver, "12 Needle Cast Ln");
		Hooks.scenario.log("Revised billing address displays successfully!");
		attachScreenShot(driver);
	}
