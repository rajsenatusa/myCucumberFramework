...
public class TOHO3_FIGA extends CommonMethods {
	...
	public void User_validates_2024_FIGA_TOHO3_rate_in_Premium_Info() throws Exception {
//		String expected = "269.66";
...
//		Assert.assertEquals("The value DOES NOT match!", expected, actual);
	...
	public void User_validates_2024_FIGA_TOHO3_rate_in_Review() throws Exception {
//		String expected = "$269.66";
