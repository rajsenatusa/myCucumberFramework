...
public class MTR365_DP3_ValidateCovCOptionsDefaultChange_NB_END extends CommonMethods{
	...
	public void user_clicks_policy_general_chevron_and_changes_occupancy_to_tenant()
			throws Exception {
	...
	public void user_clicks_dwelling_tab_and_verifies_written_message()
			throws Exception {
		click(dwellingChevron.btnDwelling);
		wait(3);
		verify_AnyText_IsVisible(driver, "Occupancy has been updated which would impact the prior coverages selected. Please review the coverages on the Dwelling page");
	}
	@When("User sets Cov C personal Property amount as <17.000>")
	public void user_sets_cov_c_personal_property_amount_as_17000()
			throws Exception {
