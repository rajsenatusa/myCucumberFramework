...
public class MTR4582_HO3_ValidateMMA_AcknowledgmentFrom_Correspondence_NB extends CommonMethods {
	...
	public void user_clicks_new_recipient_and_completes_required_information() throws Exception {
		...
		String[] recipient = { "Select...", "Insured - John Richards", "Producer - Members Insurance Center, LLC",
	...
	public void user_clicks_process_correspondance_and_validates_quote_and_agent_information_in_forms_tc36497()
			throws Exception {
