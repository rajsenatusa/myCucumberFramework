...
public class MTR358_HO3_ValidateMMAFormNotDisplayOnNB_DisplayOnEnd extends CommonMethods {
	...
	public void User_sets_new_effective_date_as_current_date_days_and_starts_endorsement_mtr358() throws Exception {
	...
	public void user_clicks_endorsement_package_link_and_validates_form_version_and_completes_test() throws Exception {
		...
		Endpackage_Form_FnE1 = SmartPDFComparator2.getPDFtextByArea(FileLocation + EndPackage_Form, 2, 40, 350, 530,
				320);
		PdfComparator.verifyFormData(driver, Endpackage_Form_FnE1,
				"AIIC HO3 CSAU 04 23Mandatory Mediation-Arbitration Endorsement");
