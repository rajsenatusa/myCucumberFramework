...
public void i_enter_product_selection_information_for_toho3_and_effective_date() {
			...
			click(product.productSelectionToho3);	
	}
...
public void i_enter_all_required_information_on_toho3_welling_screen() {
			...
			selectDropdownText(dwellingChevron.structureRentedOthers, "No");
			wait(2);
			...
			wait(4);
			click(dwellingChevron.saveButton);
			selectDropdownText(dwellingChevron.hurricaneDeductible, ConfigsReader.getProperty("hurricanedeductible"));
			wait(3);
