...
public class MTR591_HO3_ValidateWaterLossGreaterThan5000_WDE_WDL_RequiresUWApproval extends CommonMethods {
	...
	public void user_validates_due_to_loss_history_limited_water_message_displayed() throws Exception {
		verify_AnyText_IsVisible(driver, "Due to Loss History, Selection of Limited Water Requires Underwriting Approval");	
	}
	...
	public void User_clicks_modify_application_and_clicks_check_water_damage_exclusion_and_water_damage_limited() throws Exception {	    	   						
	...
	public void User_validates_labels_on_closeout_screen_with_expected_ones() throws Exception {	    	   						
		verify_AnyLabel_IsVisible(driver, "Due to Loss History, Selection of Limited Water Requires Underwriting Approval");
