...
public class VOLDP1_FIGA extends CommonMethods {
	...
	public void User_validates_2024_FIGA_VOL_DP1_rate_in_Premium_Info() throws Exception {
//		String expected = "44.01";
...
//		Assert.assertEquals("The value DOES NOT match!", expected, actual);
	...
	public void User_validates_2024_FIGA_VOL_DP1_rate_in_Review() throws Exception {
//		String expected = "$44.01";
