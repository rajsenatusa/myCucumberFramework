...
public class MTR402_TC17052_NonAllStateHO3_NB_END_NonPayCancellation_ReinstatementonPayment_NonRenewalRescind_Renewal
	...
	public void user_clicks_process_correspondance_and_validates_quote_and_agent_information_in_forms_mtr402()
			throws Exception {
	...
	public void user_clicks_declaration_link_and_validates_information_in_the_form_mtr402() throws Exception {
		...
		Declaration_Version = SmartPDFComparator2.getPDFtextByArea(FileLocation + Declaration_Form, 1, 70, 740, 100,
				50);
	...
	public void User_clicks_endorsement_package_link_and_validateS_information_in_the_form_mtr402() throws Exception {
		...
		// Declaration Page
		EndDeclaration_Version = SmartPDFComparator2.getPDFtextByArea(FileLocation + EndPackage_Form, 1, 70, 740, 100,
				50);
	...
	public void user_clicks_process_correspondance_validates_information_in_sinkhole_loss_form_mtr402()
			throws Exception {
		clickonAnyButton(driver, "ProcessCorrespondence");
		wait(8);
		switchToWindow(driver, "STFile&File");
		...
		SinkholeDenial_Data = SmartPDFComparator2.getPDFtextByArea(FileLocation + SinkholeDenial_Form, 1, 0, 0, 620,
				790);
	...
	public void user_clicks_sinkhole_denial_link_and_validates_info_mtr402() throws Exception {
		...
		SinkholeDenial_Data2 = SmartPDFComparator2.getPDFtextByArea(FileLocation + SinkholeDenial_Form2, 1, 0, 0, 620,
				790);
	...
	public void user_gets_second_next_action_date_and_changes_system_date_to_second_next_action_date_mtr402()
			throws Exception {
	...
	public void user_clicks_cancellation_notice_link_and_validates_information_in_the_form_mtr402() throws Exception {
		...
		CancellationNotice_Data = SmartPDFComparator2.getPDFtextByArea(FileLocation + CancellationNotice_Form, 1, 0, 0,
				620, 790);
	...
	public void user_clicks_cancellation_confirmation_link_and_validates_information_in_the_form_mtr402()
			throws Exception {
		...
		CancellationConfirmation_Data = SmartPDFComparator2
				.getPDFtextByArea(FileLocation + CancellationConfirmation_Form, 1, 0, 0, 620, 790);
	...
	public void user_validates_payment_confirmation_form_mtr402() throws Exception {
		...
		PaymentConfirmation_Data = SmartPDFComparator2.getPDFtextByArea(FileLocation + PaymentConfirmation_Form, 1, 0,
				0, 620, 790);
	...
	public void user_clicks_Continuation_of_Coverage_link_and_validates_information_in_the_form_mtr402()
			throws Exception {
	...
	public void user_clicks_Non_Renewal_Notice_link_and_validates_information_in_the_form_mtr402() throws Exception {
		...
		NonRenewalNotice_Data = SmartPDFComparator2.getPDFtextByArea(FileLocation + NonRenewalNotice_Form, 1, 0, 0, 620,
				790);
	...
	public void user_clicks_Rescission_of_NonRenewal_Notice_link_and_validates_information_in_the_form_mtr402()
			throws Exception {
		...
		NonRenewalRescind_Data = SmartPDFComparator2.getPDFtextByArea(FileLocation + NonRenewalRescind_Form, 1, 0, 0,
				620, 790);
