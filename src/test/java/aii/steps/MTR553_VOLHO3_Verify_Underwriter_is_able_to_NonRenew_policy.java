...
public class MTR553_VOLHO3_Verify_Underwriter_is_able_to_NonRenew_policy extends CommonMethods {
	...
	@When("User searches for the policy number <mtr553>")
	public void user_searches_policy_for_mtr553() {
	...
	public void User_completes_nonrenewal_transaction_mtr553() throws Exception {
	...
	public void User_validates_Policy_Status_displayed_as_NonRenewed_mtr553() throws Exception {
	...
	@When("User clicks Policy File Chevron <mtr553>")
	public void user_clicks_policy_file_chevron_mtr553() throws Exception {
		wait(2);
	...
	public void user_validates_Non_Renewal_notice_form_listed_and_validates_form_mtr553() throws Exception {
