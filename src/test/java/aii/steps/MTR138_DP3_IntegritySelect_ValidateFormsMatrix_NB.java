...
public class MTR138_DP3_IntegritySelect_ValidateFormsMatrix_NB extends CommonMethods {
	...
	public void user_clicks_new_business_package_link_and_validates_all_expected_forms_listed_in_the_package() throws Exception {
		...
		PdfComparator.verifyFormData(driver, NBDec2_Page, "OIR B1 1655Notice of Premium Discounts for Hurricane Loss Mitigation");
	...
	public void user_validates_assignment_form_version() throws Exception {
		NBAssignment_Version1 = SmartPDFComparator2.getPDFtextByArea(FileLocation+NBPackage_Form, 14, 490, 35, 250, 50);
		PdfComparator.verifyFormData(driver, NBAssignment_Version1, "AIIC AA 02 20");
		NBAssignment_Version = SmartPDFComparator2.getPDFtextByArea(FileLocation+NBPackage_Form, 14, 70, 740, 250, 50);
	...
	public void user_validates_policy_jacket_form_version() throws Exception {
		NBPolJacket_Version1 = SmartPDFComparator2.getPDFtextByArea(FileLocation+NBPackage_Form, 15, 470, 35, 250, 50);
	...
	public void user_validates_AIIC01DP3SP0423_form_version() throws Exception {
		...
		SPProvision_Version1 = SmartPDFComparator2.getPDFtextByArea(FileLocation+NBPackage_Form, 36, 30, 760, 120, 25);
	...
	public void user_validates_home_computer_form_version() throws Exception {
		LimitedWater_Version = SmartPDFComparator2.getPDFtextByArea(FileLocation+NBPackage_Form, 59, 455, 30, 120, 40);
		PdfComparator.verifyFormData(driver, LimitedWater_Version, "AIIC DP3 HC 09 21");
		LimitedWater_Version1 = SmartPDFComparator2.getPDFtextByArea(FileLocation+NBPackage_Form, 59, 40, 735, 150, 30);
	...
	public void user_validates_notice_hurricane_mitigation_form_version() throws Exception {
		NBHurMitigation_Version = SmartPDFComparator2.getPDFtextByArea(FileLocation+NBPackage_Form, 79, 30, 750, 90, 30);
