...
public class TC16720_TOMHO3_ValidateNOCForm_NB_ENDWindEx_Claim_RWL extends CommonMethods{
	...
	public void user_validates_HO04940697_form_is_visible_on_forms_chevron_and_validates_form_version_tc16720() throws Exception {
	...
	public void user_clicks_Endorsement_Package_and_validate_form_version_tc16720() throws Exception {
		...
		EndWindHail_Version1 = SmartPDFComparator2.getPDFtextByArea(FileLocation+EndPackage_Form, 5, 475, 50, 100, 30);
	...
	public void user_clicks_Start_Claim_button() {
		driver.findElement(By.name("StartClaim")).click();
		wait(3);
		click(dwellingChevron.btnSave);
		wait(3);
	}
	...
	public void user_finalizes_transaction_and_process_transaction_tc16720()
			throws Exception {
		click(dwellingChevron.btnFinalize);
		wait(3);
		clickProcess(driver);
	...
	@When("User validates 'HO 04 94 06 97' and Assignment Agreement Notice 01 19 form is visible on forms chevron <tc16720>")
	public void user_validates_HO04940697_and_Assignment_Agreement_Notice_form_is_visible_on_forms_chevron_tc16720() throws Exception {
		verify_AnyText_IsVisible(driver, "HO 04 94 06 97");	
	...
	public void user_clicks_Renewal_Declaration_and_validates_form_version_tc16720() throws Exception {
		...
		//Windhail exclusion form
		RwlWindHail_Version1 = SmartPDFComparator2.getPDFtextByArea(FileLocation+RwlDec_Form, 16, 475, 50, 100, 30);
		PdfComparator.verifyFormData(driver, RwlWindHail_Version1, "HO 04 94 06 97");
		RwlWindHail_Version = SmartPDFComparator2.getPDFtextByArea(FileLocation+RwlDec_Form, 16, 50, 755, 120, 30);
