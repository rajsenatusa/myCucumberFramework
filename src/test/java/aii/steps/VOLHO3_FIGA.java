...
public class VOLHO3_FIGA extends CommonMethods {
	...
	public void User_validates_2024_FIGA_VOL_HO3_rate_in_Premium_Info() throws Exception {
//		String expected = "17.26";
...
//		Assert.assertEquals("The value DOES NOT match!", expected, actual);
	...
	public void User_validates_2024_FIGA_VOL_HO3_rate_in_Review() throws Exception {
//		String expected = "$17.26";
