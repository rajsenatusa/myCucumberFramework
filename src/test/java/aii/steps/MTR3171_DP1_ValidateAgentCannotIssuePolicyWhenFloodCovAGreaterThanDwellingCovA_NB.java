...
public class MTR3171_DP1_ValidateAgentCannotIssuePolicyWhenFloodCovAGreaterThanDwellingCovA_NB extends CommonMethods {
	...
	public void user_enters_flood_covA_smaller_than_dwellingCovA_and_validates_no_error_message_displayed()
			throws Exception {
		dwellingChevron.txtFloodDwellingCovA.clear();
	...
	public void user_enters_flood_covA_larger_than_dwellingCovA_and_validates__error_message_displayed()
			throws Exception {
		dwellingChevron.txtFloodDwellingCovA.clear();
		setFloodCoverage_ADwelling(driver, "320,000");
		click(dwellingChevron.btnSave);
	...
	public void user_validates_flood_cova_cannot_be_greater_than_dwellingCoverageA_message_displayed()
			throws Exception {
		verify_AnyText_IsVisible(driver, "Flood Coverage A cannot be greater than Dwelling Coverage A");
	}
