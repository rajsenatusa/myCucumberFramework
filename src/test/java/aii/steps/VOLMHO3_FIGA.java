...
public class VOLMHO3_FIGA extends CommonMethods {
	...
	public void User_validates_2024_FIGA_TOMHO_rate_in_Worksheets() {
		String expected = "0.0100";
		String actual = dashboard.fIGA2024TOMHOWorksheets.getText();
		Assert.assertEquals("The value DOES NOT match!", expected, actual);
		wait(1);
	}

	@Then("User validates 2024 FIGA TOMHO rate in Premium Info")
	public void User_validates_2024_FIGA_TOMHO_rate_in_Premium_Info() {
		String expected = "124.43";
	...
	public void User_validates_2024_FIGA_TOMHO_rate_in_Review() {
		String expected = "$124.43";
		String actual = dashboard.fIGA2024TOMHOReview.getText();
		Assert.assertEquals("The value DOES NOT match!", expected, actual);
		wait(1);
	}
}