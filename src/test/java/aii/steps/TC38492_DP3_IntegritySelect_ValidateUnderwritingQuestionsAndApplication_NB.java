...
public class TC38492_DP3_IntegritySelect_ValidateUnderwritingQuestionsAndApplication_NB extends CommonMethods{
	...
	public void user_answers_all_underwriting_questions_for_dp3_sets_vacant_unoccupied_and_known_sinkhole_as_yes() throws Exception {
		
		verify_AnyLabel_IsVisible(driver,"Has the applicant(s) had more than 1 non-weather related losses within the past 3 years?*");
		verify_AnyLabel_IsVisible(driver,"Has the applicant(s) or insured location had 1 or more non-weather related water losses within the past 3 years?*");
		verify_AnyLabel_IsVisible(driver,"To the best of your knowledge at the time of purchase and/or building this home, were there any disclosures on the residence and/or property to be insured concerning sinkhole activity and/or cracking, movement, raveling, listing, leaning or buckling of a foundation, floor or wall?*");
		verify_AnyLabel_IsVisible(driver,"To the best of your knowledge has the insured location been vacant or unoccupied 30 or more days prior to the date purchased by the insured?");
	...
	public void user_clicks_application_form_and_saves_it_to_the_local() throws Exception {
		...
		PdfComparator.verifyFormData(driver, DP3App_Question6, "6. Has the applicant(s) had more than 1 non-weather related losses within the past 3 years? NO");
		...
		PdfComparator.verifyFormData(driver, DP3App_Question16, "Has the applicant(s) or insured location had 1 or more non-weather related water losses within the past 3");
		...
		PdfComparator.verifyFormData(driver, DP3App_Question19, "19. To the best of your knowledge at the time of purchase and/or building this home, were there any disclosures on");
		
		DP3App_Question19 = SmartPDFComparator2.getPDFtextByArea(FileLocation+DP3App_Form, 4, 30, 470, 600, 40);
				
		PdfComparator.verifyFormData(driver, DP3App_Question19, "the residence and/or property to be insured concerning sinkhole activity and/or cracking, movement, raveling,");
		PdfComparator.verifyFormData(driver, DP3App_Question19, "listing, leaning or buckling of a foundation, floor or wall? NO");
		
		DP3App_Question25 = SmartPDFComparator2.getPDFtextByArea(FileLocation+DP3App_Form, 4, 30, 600, 600, 70);
		PdfComparator.verifyFormData(driver, DP3App_Question25, "25. To the best of your knowledge has the insured location been vacant or unoccupied 30 or more days prior to");
		PdfComparator.verifyFormData(driver, DP3App_Question25, "the date purchased by the insured?");
		PdfComparator.verifyFormData(driver, DP3App_Question25, "Unoccupied means that the dwelling is not being inhabited as a residence. YES");
		...
		DP3App_selection_Page6_1 = SmartPDFComparator2.getPDFtextByArea(FileLocation+DP3App_Form, 6, 30, 350, 600, 20);
		...
		PdfComparator.verifyFormData(driver, DP3App_selection_Page7, "I declare that all of the information contained on this application is true, complete and correct to the best of my knowledge");	
	}
