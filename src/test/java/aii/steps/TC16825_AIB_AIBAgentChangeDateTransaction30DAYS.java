...
public class TC16825_AIB_AIBAgentChangeDateTransaction30DAYS extends CommonMethods{
	...
	public void user_validates_requested_effective_date_change_requires_underwriting_review_text_is_visible_tc16825() throws Exception {
	...
	public void User_validates_requested_effective_date_change_requires_uw_review_text_is_not_visible() throws Exception {
	...
	public void user_process_tx_and_validates_expected_messages_finishes_test_tc16825() throws Exception {
		...
		verify_AnyLabel_IsVisible(driver, "Change Effective Date from " + dtf.format(currentDate) + " to " + dtf.format(currentDate.plusDays(30)));
