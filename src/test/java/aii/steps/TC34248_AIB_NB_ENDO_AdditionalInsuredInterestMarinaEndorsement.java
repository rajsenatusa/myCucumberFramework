...
public class TC34248_AIB_NB_ENDO_AdditionalInsuredInterestMarinaEndorsement extends CommonMethods{
	...
	static String interestType [] = {"Select...","Additional Insured","Additional Interest(s)",
			"Additional Insured - Additional Owner", "Additional Interest - Lienholder", "Additional Interest - Lessor", "Additional Insured - Marina"};
	...
	public void User_completes_required_information_on_add_first_mortgagee_tc34248() throws Exception {
		...
		verify_AnyText_IsVisible(driver, "Additional Insured-Marina requires that the Storage Location to be listed as Marina"); 
	}
	...
	public void user_does_necessary_validations_with_different_selections_and_checks_required_messages_displayed_in_additional_interest_screen() throws Exception {
		...
		wait(5);
		verify_AnyText_NotVisible(driver, "Additional Insured-Marina requires that the Storage Location to be listed as Marina");
	...
	public void user_clicks_Small_Boat_application_Link_and_validates_form_version() throws Exception {
		...
		application_Form_FnE1 = SmartPDFComparator2.getPDFtextByArea(FileLocation+application_Form, 2, 20, 290, 560, 220);
	...
	public void user_clicks_add_additional_interest_button_and_add_Marina_as_Additional_Insured_tc34248() throws Exception {
		driver.findElement(By.id("dialogOK")).click();
		wait(1);
		click(additionalinterest.btnAdditionalInterest);
		wait(2);
