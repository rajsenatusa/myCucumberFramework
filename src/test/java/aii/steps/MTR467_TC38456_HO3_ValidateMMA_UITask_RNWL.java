...
public class MTR467_TC38456_HO3_ValidateMMA_UITask_RNWL extends CommonMethods{
	...
	public void user_completes_required_information_on_dwelling_chevron_selects_dwelling_type_mtr467() throws Exception {
	...
	public void user_changes_system_date_To_renewal_effective_date_as_current_date_plus_1_year_mtr467() throws Exception {
	...
	public void user_validates_MMA_discount_applied_on_Policy_displayed_with_policy_number_mtr467() throws Exception {
		verify_AnyText_IsVisible(driver, "Mandatory Mediation-Arbitration discount applied on Policy "+temp+". Please Review and follow up for signed acknowledgment if not received.");
	...
	public void user_selects_show_all_and_validates_MMA_discount_applied_on_policy_text_is_visible_and_do_other_validations_mtr467() throws Exception {
