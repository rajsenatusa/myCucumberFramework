...
@regression @mtr451 @dp1regression
...
AIIC DP1 MMAA 04 23 - DP1 - NB Joint After 07/01/2022
  ...
  and Acknowledgment form AIIC DP1 attaches after the application in the package
    ...
    Given User login to Spin as Standard Agent
   	...
   	And User enters all required information on policy information screen <mtr451>
   	And User enters DP1 product selection information and current date as effective date
   	And User enters all required information on DP1 quote screen with current date as prior policy date <mtr451>
