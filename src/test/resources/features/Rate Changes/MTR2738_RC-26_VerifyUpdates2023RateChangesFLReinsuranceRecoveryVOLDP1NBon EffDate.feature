...
@RateChangeReinsuranceRecoveryVOLDP1
Feature: RC-26: 2023 Rate Changes- FL Reinsurance Recovery: VOL DP1

  @RateChangeReinsuranceRecoveryVOLDP1-1
  Scenario Outline: MTR-2738: RC-26-Verify the Updates on 2023 Rate Changes- FL Reinsurance Recovery: VOL DP1 - NB on the Eff date
    ...
    Examples: Test Data
      ...
      | mkoziel  | July@2023! | 07/21/2023    | Frame            | Vacant    | 9 to 12 Months |               2021 |       3000 |                              7 |               3 | Architectural Composition Shingle | Fire Station | Full            | HIP       | Yes | Yes           | $2,000                  |                 20000 | Basement            | X                 | Yes                 | No           | Yes                  |
