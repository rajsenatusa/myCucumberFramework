...
@regression @tc17036 @mtr2465 @ho6regression
Feature: MTR2465 - HO6, UW, Task, Validate UW can create manual Task on a policy
  ...
  Scenario: Validate that Underwriter can create manual UW task for all the listed tasks on policy
    ...
    And User enters all required information on policy information screen <tc17036>
    ...
    And User enters all required information on HO6 quote screen with current date as prior policy date <tc17036>
