...
@NB_Policy_VOLHO6Reinsurance
Feature: RC-19: 2023 Rate Changes- FL Reinsurance Recovery: VOL HO6

  @RateChangeReinsuranceRecoveryHO6-1
  Scenario Outline: MTR-2766: RC-19-Verify the Updates on 2023 Rate Changes- FL Reinsurance Recovery: VOL HO6 - NB on the Eff date
   ...
   Then User verifies HO6 Elevation Certificate rate
    ...
    Examples: Test Data
      ...
      | mcemek   | Oct@2023! | 7/21/2023     | Frame            | Owner Occupied | 9 to 12 Months |               2021 |       3000 |                              7 |               3 |           3 | Architectural Composition Shingle | Yes       | Brick         | Yes     | $100,000        | Fire Station | Full            | Local Alarm  | 24 Hour Security Patrol | Yes              | HIP       | Yes | Yes           | $5,000                  | Basement            | X                 | Yes                 | No           | Yes                  |
