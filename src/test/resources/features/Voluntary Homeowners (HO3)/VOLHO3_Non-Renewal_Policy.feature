...
@RN_Policy_VOLHO3
Feature: Non Renewal Policy VOL HO3
  ...
  Scenario Outline: RN VOL HO3
    ...
    Then User validates Non Renewal HO3 policy has been created successfully
    ...
    Examples: Test Data
      ...
      | mcemek   | Jan@2024! | 01/01/2024    | Masonry          | Owner Occupied | 4 to 8 Months  |               2016 |       2500 |                              3 |               2 | 3 Tab Composition Shingle | No        | Stone         | Unknown | $50,000         | Local Alarm | Full            | Local Alarm  | 24 Hour Security Patrol | No               | A-Hurricane Impact | Gable     | No  | Yes           | $5,000                  | Slab                | D                 | Yes                 | Yes          | Yes                  |
