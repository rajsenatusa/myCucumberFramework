...
@regression @tc35721
Feature: TC 35721--DP3, Validate Owner Occupied NB Endorsement- NB INTEGRITY SELECT Text Builder
  ...
  Scenario: As an Agent, Create Integrity Select Policy, once issued, endorse to 
   change to Basic Policy, validate coverages revert and validate Text Builder
    ...
    Then User clicks Start Transaction
		...
		And User expands  endorsement on transaction history tab and verifies changes made
